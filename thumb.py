...
# Define landmark indices for CMC, MCP, IP, TIP for thumb and PIP, DIP, TIP for other fingers
finger_joints = {
...
while cap.isOpened():
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            # Highlight joints for each finger
            for finger, joints in finger_joints.items():
                # Define labels for thumb (CMC, MCP, IP, TIP) and other fingers (PIP, DIP, TIP)
                if finger == 'Thumb':
                    joint_labels = ['CMC', 'MCP', 'IP', 'TIP']
                else:
                    joint_labels = ['PIP', 'DIP', 'TIP']
                ...
                for idx, joint in enumerate(joints):
                    ...
                    # Label the joint with only the joint name
